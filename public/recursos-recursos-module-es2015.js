...
let RecursosPageModule = class RecursosPageModule {
};
...
let RecursosPage = class RecursosPage {
    constructor(login) {
        this.login = login;
    }
    ngOnInit() {
...
//# sourceMappingURL=recursos-recursos-module-es2015.js.map