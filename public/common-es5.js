...
var LoginPage = /** @class */ (function () {
    function LoginPage(authService, router, menu, fb) {
        ...
        this.myForm = this.fb.group({
            ...
            password: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].pattern(/^[a-z0-9_-]{6,18}$/)]],
        });
    }
    ...
    LoginPage.prototype.OnSubmitLogin = function () {
        var _this = this;
        this.authService.login(this.myForm.value.email, this.myForm.value.password).then(function (res) {
    ...
    LoginPage.prototype.onLoginRedirect = function () {
