...
var routes = [
    ...
    {
        path: 'home',
        loadChildren: function () { return __webpack_require__.e(/*! import() | home-home-module */ "home-home-module").then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(function (m) { return m.HomePageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    { path: 'culturas',
        loadChildren: function () { return __webpack_require__.e(/*! import() | culturas-culturas-module */ "culturas-culturas-module").then(__webpack_require__.bind(null, /*! ./culturas/culturas.module */ "./src/app/culturas/culturas.module.ts")).then(function (m) { return m.CulturasPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    { path: 'recursos',
        loadChildren: function () { return Promise.all(/*! import() | recursos-recursos-module */[__webpack_require__.e("common"), __webpack_require__.e("recursos-recursos-module")]).then(__webpack_require__.bind(null, /*! ./recursos/recursos.module */ "./src/app/recursos/recursos.module.ts")).then(function (m) { return m.RecursosPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    { path: 'cultura-descripcion',
        loadChildren: function () { return __webpack_require__.e(/*! import() | cultura-descripcion-cultura-descripcion-module */ "cultura-descripcion-cultura-descripcion-module").then(__webpack_require__.bind(null, /*! ./cultura-descripcion/cultura-descripcion.module */ "./src/app/cultura-descripcion/cultura-descripcion.module.ts")).then(function (m) { return m.CulturaDescripcionPageModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    { path: 'login',
        loadChildren: function () { return Promise.all(/*! import() | login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("login-login-module")]).then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(function (m) { return m.LoginPageModule; }); }, canActivate: [_guards_no_login_guard__WEBPACK_IMPORTED_MODULE_4__["NoLoginGuard"]]
    },
...
var AppComponent = /** @class */ (function () {
    function AppComponent(authService, platform, splashScreen, statusBar, router, menu, spinnerService, fcm) {
...
var ModalPage = /** @class */ (function () {
    function ModalPage(modalCtrl, dataApi, storage) {
    ...
    ModalPage.prototype.onUpload = function (e) {
        var _this = this;
        console.log('subir', e.target.files[0]);
        var id = Math.random().toString(36).substring(2);
        var file = e.target.files[0];
        var filePath = "culturas/cultura_" + id;
    ...
    ModalPage.prototype.AddCultura = function (formCultura) {
...
var DataApiService = /** @class */ (function () {
    ...
    DataApiService.prototype.getAllCulturas = function () {
    ...
    DataApiService.prototype.getOneCultura = function (idCultura) {
        this.culturaDoc = this.afs.doc("culturas/" + idCultura);
        return this.cultura = this.culturaDoc.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
    ...
    DataApiService.prototype.addCultura = function (cultura) {
        this.culturasCollection.add(cultura);
    };
    DataApiService.prototype.searchCulturas = function () {
        this.culturaDoc.collection('culturas').valueChanges()
            .subscribe(function (culturas) {
            return culturas;
        });
    };
    DataApiService.prototype.updateCultura = function (cultura) {
        var idCultura = cultura.id;
        this.culturaDoc = this.afs.doc("culturas/" + idCultura);
        this.culturaDoc.update(cultura);
    };
    DataApiService.prototype.deleteCultura = function (idCultura) {
        this.culturaDoc = this.afs.doc("culturas/" + idCultura);
